...
class UMP45FlashLightOffset : MiscOffset {
	default {
		Offset.WeaponClass "B_UMP45";
...
class UMP45SilencerOffset : BarrelOffset {
	default {
		Offset.WeaponClass "B_UMP45";
...
class UMP45EOTOffset : ScopeOffset {
	default {
		Offset.WeaponClass "B_UMP45";
...
class UMP45HoloRedOffset : ScopeOffset {
	default {
		Offset.WeaponClass "B_UMP45";
...
class UMP45ReflexRedOffset : ScopeOffset {
	default {
		Offset.WeaponClass "B_UMP45";
...
class UMP45AcogRedOffset : ScopeOffset {
	default {
		Offset.WeaponClass "B_UMP45";
...
class UMP45AcogRMROffset : ScopeOffset {
	default {
		Offset.WeaponClass "B_UMP45";
