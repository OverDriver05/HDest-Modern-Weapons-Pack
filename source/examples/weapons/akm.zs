class B_AKM : BaseStandardRifle {
	...
	default {
		...
		BHDWeapon.BFireSound         "weapons/ak/fire";
		BHDWeapon.BSFireSound        "weapons/ak/silentfire";
		...
		BHDWeapon.BLoadSound         "weapons/ak/clipinsert";
		BHDWeapon.BUnloadSound       "weapons/ak/clipeject";
