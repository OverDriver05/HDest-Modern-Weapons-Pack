class B_AK108 : BaseStandardRifle {
	...
	default {
		...
		inventory.pickupmessage      "You got the AK-108.";
		scale                        0.7;
		weapon.bobrangex             0.22;
		weapon.bobrangey             0.9;
		obituary                     "%o was assaulted by %k.";
		tag                          "AK-108";
		inventory.icon               "AK8PA0";
		...
		BHDWeapon.BSpriteWithMag     "AK8PA0";
	...
	states {
		...
		LayerGunBolt:
			AK8G E 3 A_StartSound(invoker.bBoltBackwardSound, CHAN_WEAPON);
			Goto LayerGun;
