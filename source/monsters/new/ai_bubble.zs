...
class ArmouredAiBubble : Actor {
	default {
		...
		+SpriteAngle
		Scale 0.7;
		ArmouredAiBubble.fora 10;
		ArmouredAiBubble.forb 3;
		ArmouredAiBubble.forc 25;
	}
	ArmouredHumanoidBase host;
...
class armoured_ai_with_bubble_base : ArmouredHumanoidBase {
	default {
		painchance 60;
		speed 15;
		seesound "grunt/sight";
	...
	virtual ArmouredAiBubble getGun() {
		return null;
	}
	states{
	raise:
