...
- Added AK-19 (w14)
	...
	- Firemodes: Semi/Auto
	- Loadout code is w14
- Added AK-108 (w15) **BROKEN TEXTURES**
...
#Known Issues:
- Cannot add in new textures for gun sprites. Don't know why. I tried recreating the AKM sprites by just altering their saturation, but it screws up the scaling. And don't get me started with importing new ones. As such, AK-15 and AK-19 uses the old AKM sprite. AK-108 has a floating gun body :( M240 uses the M249 sprites.
